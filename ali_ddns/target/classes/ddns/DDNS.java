...
public class DDNS {
    ...
    public static void resolve(String accessKey,String accessScrect,String domain,String resourceRecord,String Type) throws Exception {
        // 设置鉴权参数，初始化客户端
        DefaultProfile profile = DefaultProfile.getProfile(
                "cn-beijing",// 地域ID
                accessKey,// 您的AccessKey ID
               accessScrect);// 您的AccessKey Secret
        ...
        // 主机记录
        describeDomainRecordsRequest.setRRKeyWord(resourceRecord);
        // 解析记录类型
        ...
        if(domainRecords.size() != 0 ){
            ...
            if(!currentHostIP.equals(recordsValue)){
                ...
                // 主机记录
                updateDomainRecordRequest.setRR(resourceRecord);
                // 记录ID
